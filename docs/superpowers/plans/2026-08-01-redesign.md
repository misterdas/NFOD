...
var _EMBEDDED_CSV="<PASTE-EXISTING-STRING-HERE>";
let rawCSVData=[];
```
...
// renderGrossOIDate row count: 6 tables × 4 rows
const view = document.getElementById("view-gross");
if (NFOD.views.gross && NFOD.views.gross.render) NFOD.views.gross.render(NFOD.state);
